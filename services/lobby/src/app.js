...
const MIN_START_PLAYERS = 6;
const WINNERS = new Set(["village", "werewolf", "vampire", "draw"]);
...
async function findRoom(client, idOrCode, { lock = false } = {}) {
  const query = UUID_PATTERN.test(String(idOrCode))
